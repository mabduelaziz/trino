        ...
        implements TrinoInput
{
    ...
    public OssInput(OssLocation location, Storage storage, int readBlockSize, OptionalLong length, Optional<EncryptionKey> key)
    {
            ...
            throws IOException
    {
        ...
        try (ReadChannel readChannel = getReadChannel(getBlobOrThrow(storage, location, blobGetOptions()), location, position, readBlockSize, length, key)) {
            ...
            throw handleOssException(e, "reading file", location);
        }
    }
