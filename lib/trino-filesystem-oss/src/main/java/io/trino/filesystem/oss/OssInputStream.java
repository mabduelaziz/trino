...
import static io.trino.filesystem.oss.OssUtils.getReadChannel;
        ...
        extends TrinoInputStream
{
    ...
    public OssInputStream(OssLocation location, Blob blob, int readBlockSizeBytes, OptionalLong predeclaredLength, Optional<EncryptionKey> key)
            throws IOException
    {
            ...
            throws IOException
    {
        if (!closed) {
            ...
            try {
                ...
                throw OssUtils.handleOssException(e, "closing file", location);
            }
        }
    }
            ...
            throws IOException
    {
        try {
            ...
            throw OssUtils.handleOssException(e, "reading file", location);
        }
    }
