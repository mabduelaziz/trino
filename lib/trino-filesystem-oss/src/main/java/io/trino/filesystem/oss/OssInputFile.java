...
import static io.trino.filesystem.oss.OssUtils.getBlobOrThrow;
        ...
        implements TrinoInputFile
{
    ...
    public OssInputFile(OssLocation location, Storage storage, int readBockSize, OptionalLong predeclaredLength, Optional<Instant> lastModified, Optional<EncryptionKey> key)
    {
            ...
            throws IOException
    {
        ...
        return new OssInput(location, storage, readBlockSize, predeclaredLength, key);
    }
            ...
            throws IOException
    {
        ...
        return new OssInputStream(location, blob, readBlockSize, predeclaredLength, key);
    }
            ...
            throws IOException
    {
        ...
        try {
            ...
            throw handleOssException(e, "fetching properties for file", location);
        }
    }
