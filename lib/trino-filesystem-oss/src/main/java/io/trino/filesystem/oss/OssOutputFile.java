        ...
        implements TrinoOutputFile
{
    ...
    public OssOutputFile(OssLocation location, Storage storage, long writeBlockSizeBytes, Optional<EncryptionKey> key)
    {
            ...
            throws IOException
    {
        try {
            ...
            throw OssUtils.handleOssException(e, "writing file", location);
        }
    }
            ...
            throws IOException
    {
        try {
            ...
            return new OssOutputStream(location, writeChannel, memoryContext, writeBlockSizeBytes);
        }
        catch (RuntimeException e) {
            throwIfAlreadyExists(e);
            throw OssUtils.handleOssException(e, "writing file", location);
