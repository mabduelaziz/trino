        ...
        extends OutputStream
{
    ...
    public OssOutputStream(OssLocation location, WriteChannel writeChannel, AggregatedMemoryContext memoryContext, long writeBlockSizeBytes)
    {
        ...
        this.memoryContext = memoryContext.newLocalMemoryContext(OssOutputStream.class.getSimpleName());
